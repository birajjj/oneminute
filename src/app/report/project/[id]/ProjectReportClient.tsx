...
import type { ProjectItem } from "@/lib/project-report";
    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="no-print sticky top-0 z-10 flex flex-wrap items-center gap-2 border-b border-slate-200 bg-white px-4 py-3">
        ...
        <div className="ml-auto flex flex-wrap items-center gap-2">
          ...
          >
            {generating ? "Summarizing…" : "✨ Generate with AI"}
          </button>
          <button
            onClick={copyReport}
            className="rounded border border-slate-300 px-3 py-1.5 text-sm hover:bg-slate-100"
          ...
          <section className="mt-5">
            ...
            <div
              ...
              data-ph={
                generating
                  ? "Generating summary…"
                  : "Write a short status summary, or use ✨ Generate with AI…"
              }
            />
          </section>
